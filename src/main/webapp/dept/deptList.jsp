...
<html>
	<head>
   	...
   	<body>
        ...
        <div>
        	<form action="<%=request.getContextPath() %>/dept/deleteDept.jsp" method="post" id="multidelete">
         ...
         %>         
					<tr>
						<td><input type="checkbox" name="chk" value="<%=d.deptNo %>"></td>
                    	<td><%=d.deptNo %></td>
                     	<td><%=d.deptName %></td>
		...
		<div>
			<jsp:include page="/inc/menu.jsp"></jsp:include> <!-- %태그하고 비슷 jsp action 태그 절대주소적을때에는 contextPath 적지않음-->
   		</div>
		</div>
	</body>
</html>